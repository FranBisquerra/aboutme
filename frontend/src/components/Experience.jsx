...
function Experience() {
    return (
        <section id="experience" className="bg-gray-50 dark:bg-gray-950">
                    ...
                    {profile.experience.map((job, i) => (
                        <div key={i} className="pl-8 relative">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-2">
                                <div>
                                    <span className="font-semibold text-gray-900 dark:text-white">{job.role}</span>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">{job.description}</p>
                        </div>
                    ))}
                </div>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-20 mb-12">Education</h2>
            {profile.education.map((edu, i) => (
                <div key={i} className="pl-8 relative">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-1">
                        <div>
                            <span className="font-semibold text-gray-900 dark:text-white">{edu.degree}</span>
                            <span className="text-gray-400 mx-2">·</span>
                            <span className="text-gray-600 dark:text-gray-400">{edu.institution}</span>
                        </div>
